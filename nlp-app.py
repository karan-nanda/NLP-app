...
def draw_all(
    ...
    st.write(
        ...
        This Natural Language Processing Based Web App can do basic NLP functions such as sentiment analysis, text completion and much more 
        
        The app is built using pretrained transformers which are capable of manipulating the textual input given!
...
def main():
    ...
    menu = ["--Select--","Summarizer","Named Entity Recognition","Sentiment Analysis","Question Answering with Context","Text Completion"]
    choice = st.sidebar.selectbox("Pick from the items below !", menu)
    
    if choice=="--Select--":
        
        st.write("""
                 
                 This is a Natural Language Processing Based app that uses pipelines to generate text among other features.
        """)
        
        st.write("""
                 
                 Natural Language Processing (NLP) is a computational technique that involves basic tasks like sentiment analysis to complex tasks such as question answering
        """)
        
        st.write("""
                 
                 NLP is a sub field of Artificial Intelligence (AI) that helps machines undestand language models in a more human manner.
        """)
